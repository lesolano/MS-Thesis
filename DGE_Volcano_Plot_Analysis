...
#Ensure final published version uses updated DEG results
...
#Volcano Plot
#Import data as .csv
deHeLa0Rcnt <-read_csv("VERIFYHeLa0RvsHeLaControl.csv")
colnames(deHeLa0Rcnt)[1] <- "gene"

deHeLa8Rcnt <-read_csv("VERIFYHeLa8RvsHeLaControl.csv")
colnames(deHeLa8Rcnt)[1] <- "gene"

deHeLa8R0R <-read_csv("VERIFYHeLa8RvsHeLa0Rv2.csv")
colnames(deHeLa8R0R)[1] <- "gene"
...
deHeLa0Rcnt$delabel[deHeLa0Rcnt$diffexpressed != "NO"] <- deHeLa0Rcnt$gene[deHeLa0Rcnt$diffexpressed != "NO"]
deHeLa8Rcnt$delabel <- NA
deHeLa8Rcnt$delabel[deHeLa8Rcnt$diffexpressed != "NO"] <- deHeLa8Rcnt$gene[deHeLa8Rcnt$diffexpressed != "NO"]
deHeLa8R0R$delabel <- NA
deHeLa8R0R$delabel[deHeLa8R0R$diffexpressed != "NO"] <- deHeLa8R0R$gene[deHeLa8R0R$diffexpressed != "NO"]
